...
from plt_vnet import get_vnet_map, get_vnet_v2_map
...
imb_train_loader = DataLoader(imb_train_dataset,
                              ...
                              drop_last=True,  # 要考虑 batchsize, v2
                              shuffle=True, **kwargs)
valid_loader = DataLoader(meta_train_dataset,  # 总共 10*10=100
                          batch_size=args.batch_size,  # 100
                          drop_last=True,
                          shuffle=True, **kwargs)  # todo: shuffle False
...
- VNet(batchsize, batchsize*3, batchsize)
"""
...
if __name__ == '__main__':
    ...
    # vnet 训练是没有监督信息的，而是通过引入有监督信息的 compute_graph 的方式来训练
    vnet = VNet(args.batch_size, args.batch_size * 3, args.batch_size).cuda()
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        train_mw_v2(imb_train_loader, valid_loader,
                    model, vnet,
                    args.lr,
        ...
        with torch.no_grad():
            x, y = get_vnet_v2_map(vnet, num_pts=args.batch_size)  # 按照1-1映射思想，做出的图没有代表性
